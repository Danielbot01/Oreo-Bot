...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Oreo Bot', 'Safari', '2.0.0'] : methodCodeQR ? ['Oreo Bot', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
setInterval(async () => {
  ...
  const bio = `[ ⏳ ] Uptime: ${uptime} Oreo-Bot`;
